    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              <span className="text-2xl font-bold tracking-tight">HelpMe</span>
            </div>
      ...
      <main className="container mx-auto px-4 flex flex-col items-center justify-center py-12 flex-grow">
        ...
        <div className="text-center mb-12 max-w-lg">
          ...
          <p className="text-gray-600">Press the SOS button below to send an alert to emergency services and your emergency contacts.</p>
        </div>
